...
- 🤖 Exploring **AI/ML integrations** in security and mobile
- 💬 Ask me about: `Android` `Firebase` `Kotlin` `FastAPI` `React` `Python`
...
|--------|-------------|------------|
| [🛡️ NodeSec](https://github.com/DMEAGESWAR/NodeSec) | Attack surface intelligence platform for non-expert orgs | FastAPI · React · PostgreSQL · Docker |
| [♻️ E-Waste Picker](https://github.com/DMEAGESWAR/E-WASTE-PICKER-) | Connects users to certified e-waste recyclers | HTML · Firebase · Android WebView |
| [👓 Sunglasses Try-On](https://github.com/DMEAGESWAR/Dynamic-Sunglasses-Try-On-using-Computer-Vision-OpenCV-) | Real-time virtual try-on using face detection | Python · OpenCV · MediaPipe |
...
> Contributions will be listed here as PRs get merged 🚀
...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=DMEAGESWAR&label=Profile+views&color=blueviolet&style=flat"/>
</p>
